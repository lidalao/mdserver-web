...
Install_openresty()
{
	...
	if [ ! -f ${openrestyDir}/nginx-dav-ext-module.tar.gz ];then
		wget -O ${openrestyDir}/nginx-dav-ext-module-3.0.0.tar.gz https://github.com/arut/nginx-dav-ext-module/archive/refs/tags/v3.0.0.tar.gz
	fi

	cd ${openrestyDir} && tar -zxvf openresty-${VERSION}.tar.gz && tar -zxvf nginx-dav-ext-module-3.0.0.tar.gz
